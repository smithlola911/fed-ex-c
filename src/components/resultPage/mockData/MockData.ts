...
export const mockPackages: Package[] = [
  ...
  {
    package_id: 'PKG037',
    dateCreated: '9/23/2025', // m/d/y
    sender: {
      name: 'Mr Michael',
      address: '1242 S Canal St Chicago, Illinois 60607',
    ...
    tracking_number: 'Fedex/USA/25/0025653',
    package_details: {
      weight_kg: 10,
      dimensions_cm: {
        length: 30,
      ...
      courier: 'Fedex',
      packages: 'Car, Bag, Money, Document and Gold',
      quantity: '1,2,3,4',
  ...
  {
    package_id: 'PKG045',
    dateCreated: '11/6/2025', // m/d/y
    sender: {
      name: 'Citibank',
      address: '12880 Albrook Dr, Denver, CO 80239, United States',
      contact_number: '800-347-****',
      email: '******'
    },
    recipient: {
      name: 'Rahn Rogers',
      address: '5906 silent oaks Humble tx 77346',
      contact_number: '7133****',
      email: '******'
    },
    tracking_number: '726626772886',
    package_details: {
      weight_kg: 10,
      dimensions_cm: {
        length: 30,
    ...
    // Y-M-D
    package_received_date: '2025-11-04',
    package_received_time: '14:30:00',
  ...
  {
    package_id: 'PKG046',
    dateCreated: '11/11/2025', // m/d/y
    sender: {
      name: 'Velma Melinda',
      address: '117 Resource Center Pkwy, Birmingham, AL, 35242.',
      contact_number: '******',
      email: '******'
    },
    recipient: {
      name: 'Ron Livingston',
      address: '2439 Meadow Ridge Dr, Chino Hills, CA 91709',
      contact_number: '******',
      email: '******'
    },
    tracking_number: '726626772887',
    package_details: {
      weight_kg: 10,
      dimensions_cm: {
        length: 30,
      ...
      quantity: '1',
      paymentMode: 'Cash',
      origin: 'Birmingham, USA',
      destination: 'California, USA',
      comment: 'Handle with care',
      mode: 'Road'
    },
    // Y-M-D
    package_received_date: '2025-11-11',
    package_received_time: '14:30:00',
    in_transit_date: '2025-11-12',
    in_transit_time: '16:00:00',
    on_hold_date: '2025-11-15',
    on_hold_time: '21:30:00',
    on_hold_desc: 'Package on hold due to customs clearance.',
    out_for_delivery_date: '2025-11-14',
    out_for_delivery_time: '18:00:00',
  ...
  },
  {
    ...
    out_for_delivery_date: '2026-03-20',
    out_for_delivery_time: '16:30:00',
    on_hold_date: '2026-03-27',
    on_hold_time: '21:00:00',
    on_hold_desc: 'Package on hold due to customs clearance.',
    estimated_delivery_date: '2026-03-27',
    estimated_delivery_time: '22:00:00',
    time_zone: 'America/Chicago'
  },
  {
    ...
    out_for_delivery_time: '22:00:00',
    on_hold_date: '2026-03-11',
    on_hold_time: '04:00:00',
    on_hold_desc: 'Package on hold due to customs clearance.',
    estimated_delivery_date: '2026-03-11',
    estimated_delivery_time: '05:00:00',
